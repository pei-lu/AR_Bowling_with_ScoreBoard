...
namespace Qualcomm.Snapdragon.Spaces
{
    ...
    internal struct XrCameraFrameDataQCOM
    {
        ...
        public XrCameraFrameDataQCOM(IntPtr /* XrCameraFrameBuffersQCOM */ frameBuffers, ulong handle = 0, XrCameraFrameFormatQCOM format = 0, uint frameNumber = 0, long timestamp = 0) {
