...
namespace Qualcomm.Snapdragon.Spaces
{
    ...
    internal struct XrCameraSensorIntrinsicsQCOM
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)] private float[] _radialDistortion;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] private float[] _tangentialDistortion;
