        ...
        private class CameraProvider : Provider
        {
            ...
            public override void Stop() {
                ...
                if (!_underlyingFeature.TryReleaseFrame()) {
                    Debug.LogError("Could not release frame with handle ["+ _underlyingFeature.LastFrameHandle + "].");
                }
            ...
            public override bool TryAcquireLatestCpuImage(out XRCpuImage.Cinfo cameraImageCinfo) {
                ...
                cameraImageCinfo = new XRCpuImage.Cinfo(
                    ...
                    (int) Marshal.PtrToStructure<XrCameraFrameBufferQCOM>(Marshal.PtrToStructure<XrCameraFrameBuffersQCOM>(frameData.Next).FrameBuffers).PlaneCount,
                    frameData.Timestamp,
            ...
            public override Feature currentLightEstimation {
                get => _currentLightEstimation;
            }
