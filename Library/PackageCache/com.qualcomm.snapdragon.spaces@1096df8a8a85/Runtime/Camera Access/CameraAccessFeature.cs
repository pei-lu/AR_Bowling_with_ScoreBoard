...
namespace Qualcomm.Snapdragon.Spaces
{
    ...
    internal sealed partial class CameraAccessFeature : SpacesOpenXRFeature
    {
        ...
        internal ulong LastFrameHandle => _lastFrameHandle;
        ...
        protected override void OnSubsystemCreate() => CreateSubsystem<XRCameraSubsystemDescriptor, XRCameraSubsystem>(_cameraSubsystemDescriptors, CameraSubsystem.ID);

        protected override void OnSubsystemStop() => StopSubsystem<XRCameraSubsystem>();

        protected override void OnSubsystemDestroy()  => DestroySubsystem<XRCameraSubsystem>();
        ...
        public bool TryAccessFrame(ulong cameraHandle, XrCameraFrameConfigurationQCOM frameConfig, uint sensorCount) {
            ...
            _lastFrameHandle = frameData.Handle;
        ...
        public bool TryReleaseFrame() {
            ...
            var result = _xrReleaseFrameQCOM(_lastFrameHandle);
            if (result != XrResult.XR_SUCCESS) {
