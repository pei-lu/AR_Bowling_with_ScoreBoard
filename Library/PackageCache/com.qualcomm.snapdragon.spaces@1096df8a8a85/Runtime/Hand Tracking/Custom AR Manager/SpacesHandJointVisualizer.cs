...
namespace Qualcomm.Snapdragon.Spaces
{
    ...
    public class SpacesHandJointVisualizer : MonoBehaviour
    {
        ...
        [Tooltip("Scale to be used for all joints displayed.")]
        [Range(0.005f, 0.05f)]
        ...
        private bool _usingMaterialFilters = false;
        ...
        private void Start() {
            ...
            _universalRenderingPipeline = UnityEngine.Rendering.GraphicsSettings.currentRenderPipeline != null;
