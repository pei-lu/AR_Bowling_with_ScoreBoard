    ...
    internal sealed partial class SpatialAnchorsFeature : SpacesOpenXRFeature
    {
        ...
        public Tuple<Pose, TrackingState> TryGetSpatialAnchorSpacePoseAndTrackingState(ulong anchorSpaceHandle) {
            ...
            if (_xrLocateSpacePtr != null) {
                ...
                /* Because the struct can't have inline decleration, we shall init values after creating a struct object. */
        ...
        public bool TryPersistSpatialAnchor(ulong spatialAnchorStore, ulong spatialAnchorHandle, string anchorName) {
