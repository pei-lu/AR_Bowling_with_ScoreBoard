/******************************************************************************
 * File: SpacesReferenceImageConfiguratorEditor.cs
...
namespace Qualcomm.Snapdragon.Spaces.Editor
{
    ...
    public class SpacesReferenceImageConfiguratorEditor : UnityEditor.Editor
    {
		...
		private static Dictionary<string, SpacesImageTrackingMode> _lastSavedValues = new Dictionary<string, SpacesImageTrackingMode>();
        ...
        private HashSet<string> _validTrackingModeNames = new HashSet<string>();

        private void OnEnable() {
            Undo.undoRedoPerformed += UndoCallback;

            _trackedImageManager = new SerializedObject(FindObjectOfType<ARTrackedImageManager>());
        ...
        /// Use case for this: user edits a modes asset. Then removes an image from the reference library. Then reedits the modes asset
        /// </summary>
        ...
        /// Will attempt to repopulate the tracking mode for this reference image with previous data from the session if possible,
        /// otherwise initialises to a default value.
        /// </summary>
        /// <param name="referenceImageName">The name of the reference image to get the tracking mode for</param>
        /// <param name="spacesImageTrackingMode">The tracking mode for the chosen reference image. TrackingMode.DYNAMIC by default.</param>
        /// <returns>True if the tracking mode was added to the configurator, False otherwise. The out value trackingMode is correct and useable in both cases.</returns>
        ...
        public override void OnInspectorGUI() {
            ...
            if (_referenceImages == null) {
                EditorGUILayout.HelpBox("Needs a valid XR Reference Image Library.\n" +
	                "Make sure that AR Tracked Image Manager has a valid Serialized Library", MessageType.Warning);
        ...
        private static readonly GUIContent _dynamicMode = new GUIContent("Dynamic (Default)", "Dynamic mode updates the position of tracked images frequently, and works on moving and static targets.\n\n" +
        ...
        private static readonly GUIContent _staticMode = new GUIContent("Static", "Static mode is useful for tracking images that are known to be static, which leads to less power consumption and greater performance." +
        ...
        private static readonly GUIContent _adaptiveMode = new GUIContent("Adaptive", "Adaptive mode works on static images, but periodically updates the pose of tracked images if they have moved slightly.\n\n" +
        ...
        private static readonly GUIContent[] _toolbarEntries = new[] { _dynamicMode, _staticMode, _adaptiveMode/*, _disabledMode*/ };
        ...
        static Vector2Int CalculateAspectRatio(Texture2D texture) {
            ...
            if (getWidthAndHeightDelegate == null) {
                ...
                getWidthAndHeightDelegate = Delegate.CreateDelegate(typeof(GetWidthAndHeight), null, methodInfo) as GetWidthAndHeight;
            }
        ...
        static Texture2D TexturePreviewField(Texture2D texture) {
